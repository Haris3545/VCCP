  ...
  try {
    ...
    return {
      ...
      ...(isPinned()
        ? {}
        : {
            notice: `This idea board isn't pinned yet (id ${blobId}). Set IDEAS_JSONBLOB_ID=${blobId} in your deployment's env vars so it doesn't reset on a future cold start.`,
          }),
    };
  } catch (err) {
