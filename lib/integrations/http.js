...
// Wipes every memoized fetch (tokens, resolved artist IDs, section data) so
// the next call to each integration re-fetches from the live API instead of
// serving a cached value. Used by the "Refresh everything" button.
